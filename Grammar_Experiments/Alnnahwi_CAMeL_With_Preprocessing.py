...
def evaluate_all():
    ...
    with open("alnnahwi_camel_with_preprocessing.txt", "w", encoding="utf-8") as f:
...
"""
    ...
    with open("alnnahwi_camel_with_preprocessing.txt", "a", encoding="utf-8") as f:
        f.write(summary)
    ...
    df.to_csv(
        "alnnahwi_camel_with_preprocessing.csv",
        index=False
    )

    print("\n✓ alnnahwi_camel_with_preprocessing.csv saved")
